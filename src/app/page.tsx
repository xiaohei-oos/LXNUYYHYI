              ...
              {latestPosts.map(post => (
                ...
                >
                  <div className="aspect-[16/10] bg-muted overflow-hidden">
                    <img src={getBlogCover(post.cover_image, post.slug)} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="p-5">
